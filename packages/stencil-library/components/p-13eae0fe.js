 ...
 */
function validateHighlightText(text, highlight) {
    const trimmedText = text.trim();
    const trimmedHighlight = highlight === null || highlight === void 0 ? void 0 : highlight.trim();
...
export { isValuePositive as i, validateHighlightText as v };

//# sourceMappingURL=p-13eae0fe.js.map