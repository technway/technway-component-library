 ...
 */
import { p as proxyCustomElement, H, c as createEvent, h, d as Host } from './p-51091f4a.js';
...
import { d as defineCustomElement$2 } from './p-3886544a.js';
import { d as defineCustomElement$1 } from './p-3569ee08.js';
...
const TnwInput = /*@__PURE__*/ proxyCustomElement(class TnwInput extends H {
    ...
    render() {
        return (h(Host, { key: '27952a6a86ad7936230c4f82f9fe496f5b3d87b3' }, this.renderLabel(), h("input", Object.assign({ key: 'e9f8ae1adea8b04c2441906fd30ca04d3df4225a', class: this.getInputClasses(), id: this.uniqueId, type: this.type, name: this.name, value: this.store.get('inputValue'), required: this.isRequired, placeholder: this.placeholder, maxlength: this.maxlength, minlength: this.minlength, pattern: this.pattern, autocomplete: this.autoComplete, disabled: this.disabled }, this.getAriaAttributes(), { onInput: this.handleInputOnInput, onChange: this.handleInputOnChange, part: 'input' })), this.renderAlert() || this.renderHelpText()));
    }
    get el() { return this; }
}, [1, "tnw-input", {
        "label": [1],
...
//# sourceMappingURL=p-cb0db4d2.js.map