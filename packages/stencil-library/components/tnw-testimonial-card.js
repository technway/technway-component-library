...
const TnwTestimonialCard$1 = /*@__PURE__*/ proxyCustomElement(class TnwTestimonialCard extends H {
    ...
    render() {
        return (h(Host, { key: 'd0f202870259d12d799ae2c65a4775b23eb08cb3', class: this.getHostClasses() }, this.renderAuthorDetails(), h("tnw-text", { key: '97b7b7fb55a105005a9aa08ed9094cc2182bae16', text: this.text, class: `${this.baseClass}__description`, part: 'description', lineHeight: '1_75', weight: '300' })));
    }
    get el() { return this; }
