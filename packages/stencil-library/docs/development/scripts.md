...
This documentation provides an overview of the scripts available in the project, including details on what each script does and how it should be used. Please ensure that you have the recommended Node.js and npm versions installed:

- **Node.js Version**: `v20.16.0`
- **npm Version**: `v10.8.1`

Additionally, make sure that the necessary packages are installed locally, with some tools like Vercel needing to be installed globally.
...
npm run g:component <tag-name>

# Generate the stories directory and file for Storybook integration
npm run g:components-stories <tag-name>
...
- **`test.coverage`**  
  ...
  # OR using a path
  npm run test.coverage .storybook/utils/
  ```
...
- **`build:build:components-css-utils`**  
  ...
  ```bash
  npm run build:build:components-css-utils
  ```

- **`g:stories`**  
  for generating stories files for group of components
  ```bash
  npm run g:stories <component-1,component2>
  # For all components
  npm run g:stories all
  ```

- **`g:components-mdx`**  
  for generating mdx content from the readme.md files, require having a readme.md for the targeted components
  ```bash
  npm run g:components-mdx <component-1,component2>
  # For all components
  npm run g:components-mdx all
  ```

- **`g:components-usage`**  
  for generating usage files for the components
  ```bash
  npm run g:components-usage <component-1,component2>
  # For all components
  npm run g:components-usage all
  ```
...
- **`g:components-validations`**  
  ...
  ```bash
  npm run g:components-validations <component-1,component2>
  # For all components
  npm run g:components-validations all
  ```
...
- **`g:components-css-utils`**  
  ...
  ```bash
  npm run g:components-css-utils <component-1,component2>
  # For all components
  npm run g:components-css-utils all
  ```
