...
| **appearance** | <div>The appearance style of the accordion.</div> | `'outlined'` | `"none"` \| `"outlined"` \| `"solid"` \| `"transparent"` \| `"underlined"` |
| **borderRadius** | <div>The border radius of the accordion.</div> | `"default"` | `"2xl"` \| `"3xl"` \| `"circle"` \| `"default"` \| `"full"` \| `"lg"` \| `"md"` \| `"none"` \| `"sm"` \| `"xl"` \| `"xs"` |
| **color** | <div>The color variant of the accordion text.</div> | N/A | `"auto"` \| `"black"` \| `"gray100"` \| `"gray200"` \| `"gray300"` \| `"gray400"` \| `"gray500"` \| `"gray600"` \| `"gray700"` \| `"gray800"` \| `"gray900"` \| `"inverse"` \| `"light"` \| `"placeholder"` \| `"primary"` \| `"secondary"` \| `"white"` |
...
| **variant** | <div>The color variant of the accordion, determining the overall color scheme.</div> | `'auto'` | `"auto"` \| `"black"` \| `"inverse"` \| `"light"` \| `"primary"` \| `"secondary"` \| `"white"` |
