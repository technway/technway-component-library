...
| --- | --- | --- | --- |
| **accordionId** | Unique ID of the accordion item. Used for accessibility. | N/A | `string` |
| **appearance** | The appearance style of the accordion. | `'outlined'` | `"none"` \| `"outlined"` \| `"solid"` \| `"transparent"` \| `"underlined"` |
| **borderRadius** | The border radius of the accordion. | `"default"` | `"2xl"` \| `"3xl"` \| `"circle"` \| `"default"` \| `"full"` \| `"lg"` \| `"md"` \| `"none"` \| `"sm"` \| `"xl"` \| `"xs"` |
| **color** | The color variant of the accordion text. | N/A | `"auto"` \| `"black"` \| `"gray100"` \| `"gray200"` \| `"gray300"` \| `"gray400"` \| `"gray500"` \| `"gray600"` \| `"gray700"` \| `"gray800"` \| `"gray900"` \| `"inverse"` \| `"light"` \| `"placeholder"` \| `"primary"` \| `"secondary"` \| `"white"` |
| **content** | The content for the accordion body. | N/A | `string` |
| **disableExpandIconRotate** | If `true`, the arrow icon rotates when the accordion is expanded to visually indicate the state change. | `false` | `boolean` |
| **enableCustomExpandIcon** | If `true`, a custom icon can be provided via the `icon` slot instead of the default icon. | `false` | `boolean` |
| **expand** | If `true`, the accordion item will be expanded by default. | `false` | `boolean` |
| **heading** | The heading of the accordion item, displayed in the header. | N/A | `string` |
| **variant** | The color variant of the accordion, determining the overall color scheme. | `'auto'` | `"auto"` \| `"black"` \| `"inverse"` \| `"light"` \| `"primary"` \| `"secondary"` \| `"white"` |
