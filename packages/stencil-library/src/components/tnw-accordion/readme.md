...
| `appearance`              | `appearance`                 | The appearance style of the accordion.                                                                  | `"none" \| "outlined" \| "solid" \| "transparent" \| "underlined"`                                                                                                                                                       | `'outlined'` |
| `borderRadius`            | `border-radius`              | The border radius of the accordion.                                                                     | `"2xl" \| "3xl" \| "circle" \| "default" \| "full" \| "lg" \| "md" \| "none" \| "sm" \| "xl" \| "xs"`                                                                                                                    | `"default"`  |
| `color`                   | `color`                      | The color variant of the accordion text.                                                                | `"auto" \| "black" \| "gray100" \| "gray200" \| "gray300" \| "gray400" \| "gray500" \| "gray600" \| "gray700" \| "gray800" \| "gray900" \| "inverse" \| "light" \| "placeholder" \| "primary" \| "secondary" \| "white"` | `undefined`  |
...
| `variant`                 | `variant`                    | The color variant of the accordion, determining the overall color scheme.                               | `"auto" \| "black" \| "inverse" \| "light" \| "primary" \| "secondary" \| "white"`                                                                                                                                       | `'auto'`     |
