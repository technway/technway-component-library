...
| `borderRadius` | `border-radius` | The border radius of the badge.                                                                             | `"2xl" \| "3xl" \| "circle" \| "default" \| "full" \| "lg" \| "md" \| "none" \| "sm" \| "xl" \| "xs"`                              | `'lg'`       |
| `label`        | `label`         | The text or label displayed inside the badge. If not provided, custom content can be inserted via the slot. | `number \| string`                                                                                                                 | `undefined`  |
| `size`         | `size`          | The size of the badge.                                                                                      | `"lg" \| "md" \| "sm"`                                                                                                             | `'sm'`       |
| `variant`      | `variant`       | The color variant of the badge, determining the overall color scheme.                                       | `"auto" \| "black" \| "danger" \| "info" \| "inverse" \| "light" \| "primary" \| "secondary" \| "success" \| "warning" \| "white"` | `'auto'`     |
