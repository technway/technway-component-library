...
| ----------------- | ------------------ | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `appearance`      | `appearance`       | Specifies the appearance style of the button.                                      | `"mixed" \| "none" \| "outlined" \| "solid" \| "transparent"`                                                                      | `'solid'`   |
...
| `hoverAppearance` | `hover-appearance` | Specifies the hover appearance style for the button.                               | `"none" \| "outlined" \| "solid"`                                                                                                  | `'none'`    |
| `hoverVariant`    | `hover-variant`    | Specifies the hover variant color for the button color.                            | `"auto" \| "black" \| "inverse" \| "primary" \| "secondary" \| "white"`                                                            | `'primary'` |
...
| `variant`         | `variant`          | Defines the color variant of the button.                                           | `"auto" \| "black" \| "danger" \| "info" \| "inverse" \| "light" \| "primary" \| "secondary" \| "success" \| "warning" \| "white"` | `'primary'` |
