...
| --- | --- | --- | --- |
| **VerticalPadding** | <div>Defines the vertical padding of the banner.</div> | `'2xl'` | `"2xl"` \| `"3xl"` \| `"4xl"` \| `"lg"` \| `"md"` \| `"none"` \| `"sm"` \| `"xl"` \| `"xs"` |
...
| **horizontalPadding** | <div>Defines the horizontal padding of the banner.</div> | `'2xl'` | `"2xl"` \| `"3xl"` \| `"4xl"` \| `"lg"` \| `"md"` \| `"none"` \| `"sm"` \| `"xl"` \| `"xs"` |
| **margin** | <div>Defines the margin of the banner.</div> | `'xl'` | `"2xl"` \| `"3xl"` \| `"4xl"` \| `"lg"` \| `"md"` \| `"none"` \| `"sm"` \| `"xl"` \| `"xs"` |
| **variant** | <div>Specifies the primary color variant of the banner. if appearance is gradient, this prop will be ignored.</div> | `'primary'` | `"auto"` \| `"black"` \| `"inverse"` \| `"light"` \| `"primary"` \| `"secondary"` \| `"white"` |
