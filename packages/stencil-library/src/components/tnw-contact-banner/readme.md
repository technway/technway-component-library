...
| `appearance`        | `appearance`          | Defines the visual appearance of the banner (e.g., solid, outline).                                                                                                                      | `"mixed" \| "outlined" \| "solid" \| "transparent"`                                                   | `'solid'`   |
...
| `enableContentSlot` | `enable-content-slot` | If `true`, the banner will render custom content using the `content` slot.  When this is enabled, the standard slots (`short-title`, `title`, `description`, `button`) will not be used. | `boolean`                                                                                             | `false`     |
| `variant`           | `variant`             | Specifies the primary color variant of the banner.                                                                                                                                       | `"auto" \| "black" \| "inverse" \| "light" \| "primary" \| "secondary" \| "white"`                    | `'primary'` |
