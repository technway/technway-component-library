...
| `contentMaxWidth`          | `content-max-width`          | Specifies the maximum width of the content within the banner. use `unset` to remove the limit.                                                                                                                                      | `"lg" \| "md" \| "sm" \| "unset" \| "xl"`                                                             | `'unset'`   |
| `contentWidth`             | `content-width`              | Specifies the width of the content within the banner.                                                                                                                                                                               | `"full" \| "half"`                                                                                    | `'half'`    |
...
| `disableInternalContainer` | `disable-internal-container` | If `false`, a container class will be added around the content to align it within the page layout. Default is `false`.                                                                                                              | `boolean`                                                                                             | `false`     |
...
| `verticalCenter`           | `vertical-center`            | If `true`, the content will be vertically centered within the banner.                                                                                                                                                               | `boolean`                                                                                             | `false`     |
| `width`                    | `width`                      | <span style="color:red">**[DEPRECATED]**</span> since v2.2.0. Use `contentWidth` & `contentMaxWidth` instead.<br/><br/>Specifies the width of the banner. It can be set to predefined size types or 'full' for full-width coverage. | `"full" \| "lg" \| "md" \| "sm" \| "xl"`                                                              | `'full'`    |
