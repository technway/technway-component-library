...
| `headingTag`  | `heading-tag`   | <span style="color:red">**[DEPRECATED]**</span> since v1.0.0<br/><br/>Specifies the HTML tag to be used for the heading. | `"div" \| "h1" \| "h2" \| "h3" \| "h4" \| "h5" \| "h6"`                                                                                                                                                                  | `'h2'`      |
| `level`       | `level`         | Specifies the HTML tag to be used for the heading.                                                                       | `"div" \| "h1" \| "h2" \| "h3" \| "h4" \| "h5" \| "h6"`                                                                                                                                                                  | `'h2'`      |
