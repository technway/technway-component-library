...
| `headingTag`      | `heading-tag`      | <span style="color:red">**[DEPRECATED]**</span> since v1.0.0. Use `level` instead.<br/><br/>Specifies the HTML tag to be used for the heading. | `"div" \| "h1" \| "h2" \| "h3" \| "h4" \| "h5" \| "h6"`                                                                                                                                                                  | `undefined` |
...
| `level`           | `level`            | Specifies the HTML tag to be used for the heading.                                                                                             | `"h1" \| "h2" \| "h3" \| "h4" \| "h5" \| "h6"`                                                                                                                                                                           | `'h2'`      |
