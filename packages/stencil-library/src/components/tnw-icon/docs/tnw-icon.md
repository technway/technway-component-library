...
| --- | --- | --- | --- |
| **appearance** | <div>Determines the visual appearance color of the icon (e.g., solid, outlined).</div> | `'none'` | `"mixed"` \| `"none"` \| `"outlined"` \| `"solid"` \| `"transparent"` |
| **appearanceColor** | <div>Defines the appearance color of the icon.</div> | `'auto'` | `"auto"` \| `"black"` \| `"danger"` \| `"info"` \| `"inverse"` \| `"light"` \| `"primary"` \| `"secondary"` \| `"success"` \| `"warning"` \| `"white"` |
| **borderRadius** | <div>Determines the border radius of the icon.</div> | `'default'` | `"2xl"` \| `"3xl"` \| `"circle"` \| `"default"` \| `"full"` \| `"lg"` \| `"md"` \| `"none"` \| `"sm"` \| `"xl"` \| `"xs"` |
| **color** | <div>Sets the color of the icon. This will be used to set the color of the icon element.
Not supported when svg is enabled.</div> | `'auto'` | `"auto"` \| `"black"` \| `"gray100"` \| `"gray200"` \| `"gray300"` \| `"gray400"` \| `"gray500"` \| `"gray600"` \| `"gray700"` \| `"gray800"` \| `"gray900"` \| `"inverse"` \| `"light"` \| `"placeholder"` \| `"primary"` \| `"secondary"` \| `"white"` |
...
| **size** | <div>Specifies the size of the icon. The size means that the icon will have the width same as the height.</div> | `'sm'` | `"2xl"` \| `"2xs"` \| `"3xl"` \| `"3xs"` \| `"lg"` \| `"md"` \| `"sm"` \| `"xl"` \| `"xs"` |
