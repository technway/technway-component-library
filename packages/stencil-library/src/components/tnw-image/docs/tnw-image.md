...
| **height** | <div>The height of the image. this will be applied to the `<img>` element. Value should be a valid CSS unit, such as `px`, `em`, or `%`.</div> | N/A | `string` |
| **heightSize** | <div>The height size of the image. This controls the height of the image container. Values are not units, but rather like `full`, `lg`, `md` ...</div> | N/A | `"full"` \| `"lg"` \| `"md"` \| `"sm"` \| `"unset"` |
...
| **link** | <div>The link to navigate to when the image is clicked. This is useful for creating clickable images, e.g, for logo.</div> | N/A | `string` |
...
| **width** | <div>The width of the image. this will be applied to the `<img>` element. Value should be a valid CSS unit, such as `px`, `em`, or `%`.</div> | N/A | `string` |
| **widthSize** | <div>The width size of the image. This controls the width of the image container. Values are not units, but rather like `full`, `lg`, `md` ...</div> | `'full'` | `"full"` \| `"lg"` \| `"md"` \| `"sm"` \| `"unset"` |
