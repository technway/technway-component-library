...
| **heightSize** | <div>The height size of the image. This controls the height of the image container. Values are not units, but rather like `full`, `lg`, `md` ...</div> | N/A | `"full"` \| `"lg"` \| `"md"` \| `"sm"` |
...
| **widthSize** | <div>The width size of the image. This controls the width of the image container. Values are not units, but rather like `full`, `lg`, `md` ...</div> | `'full'` | `"full"` \| `"lg"` \| `"md"` \| `"sm"` |
