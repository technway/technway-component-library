...
| --- | --- | --- | --- |
| **BorderRadius** | Determines the border radius of the image. | `'default'` | `"2xl"` \| `"3xl"` \| `"circle"` \| `"default"` \| `"full"` \| `"lg"` \| `"md"` \| `"none"` \| `"sm"` \| `"xl"` \| `"xs"` |
| **alt** | The alternative text for the image, used for accessibility. | N/A | `string` |
| **aspectRatio** | The aspect ratio of the image (width / height). Useful for maintaining image proportions. | `"initial"` | `"16_9"` \| `"1_1"` \| `"21_9"` \| `"3_4"` \| `"4_3"` \| `"9_16"` \| `"9_21"` \| `"initial"` |
| **caption** | An optional caption to be displayed below the image. | `''` | `string` |
| **heightSize** | The height size of the image. | N/A | `"full"` \| `"lg"` \| `"md"` \| `"sm"` |
| **lazyLoading** | If `true`, the image will use lazy loading, loading only when it is about to be visible in the viewport. | `false` | `boolean` |
| **objectFit** | Defines how the image should be resized to fit its container. This controls the CSS `object-fit` property. | N/A | `"contain"` \| `"cover"` \| `"fill"` \| `"none"` \| `"scale-down"` |
| **objectPosition** | The object position of the image. This defines how the image is positioned within its container. | `"initial"` | `"bottom"` \| `"bottom-left"` \| `"bottom-right"` \| `"center"` \| `"center-bottom"` \| `"center-left"` \| `"center-right"` \| `"center-top"` \| `"initial"` \| `"left"` \| `"left-bottom"` \| `"left-top"` \| `"right"` \| `"right-bottom"` \| `"right-top"` \| `"top"` \| `"top-left"` \| `"top-right"` |
| **src** | The source URL/Path of the image. | N/A | `string` |
| **widthSize** | The width size of the image. | `'full'` | `"full"` \| `"lg"` \| `"md"` \| `"sm"` |
