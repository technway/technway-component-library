...
| --- | --- | --- | --- |
| **controlsSize** | Sets the size of the control buttons. | `'md'` | `"lg"` \| `"md"` \| `"sm"` |
| **enableControlsSlots** | If `true`, the `control-prev-icon` and `control-next-icon` slots will be shown. | `false` | `boolean` |
| **fitWithContainer** | If `true`, the carousel width will be cut to match the container width. | `false` | `boolean` |
| **hideControls** | Determines whether navigation controls are shown. | `false` | `boolean` |
| **showEdgesShadows** | If `true`, shadow effects will be shown on the edges of the carousel. | `false` | `boolean` |
| **slidesCount** | The number of slides in the carousel. | `0` | `number` |
| **slidesSize** | Sets the size of the slides. | `'sm'` | `"lg"` \| `"md"` \| `"none"` \| `"sm"` |
