...
| --- | --- | --- | --- |
| **hideBelowBreakpoint** | <div>Hides the menu below a specified breakpoint width (in pixels).</div> | `"767"` | `"1024"` \| `"767"` |
| **itemsBorderRadius** | <div>Sets the border-radius of the menu items.</div> | `'default'` | `"2xl"` \| `"3xl"` \| `"circle"` \| `"default"` \| `"full"` \| `"lg"` \| `"md"` \| `"none"` \| `"sm"` \| `"xl"` \| `"xs"` |
| **itemsColor** | <div>Sets the text color of the menu items.</div> | `'auto'` | `"auto"` \| `"black"` \| `"gray100"` \| `"gray200"` \| `"gray300"` \| `"gray400"` \| `"gray500"` \| `"gray600"` \| `"gray700"` \| `"gray800"` \| `"gray900"` \| `"inverse"` \| `"light"` \| `"placeholder"` \| `"primary"` \| `"secondary"` \| `"white"` |
| **itemsData** | <div>The menu data as a JSON string. Each item should include a label, optional link, optional newTab, and optional subMenu. The JSON format should be an array of objects, where each object can include the following properties: - `label`: The text of the menu item. - `link`: (Optional) The URL for the menu item. - `newTab`: (Optional) A boolean indicating whether the link opens in a new tab. - `subMenu`: (Optional) An array of submenu items including item `label`, `link`, and optional newTab..</div> | N/A | `string` |
| **itemsHoverAppearance** | <div>Defines the appearance of the hover effect for the menu items (e.g., solid, outlined).</div> | `'color'` | `"color"` \| `"none"` \| `"outlined"` \| `"solid"` |
| **itemsHoverEffect** | <div>Sets the hover effect for the menu items.</div> | N/A | `"contrast"` \| `"opacity"` |
| **itemsHoverVariant** | <div>Sets the hover variant color for the menu items.</div> | `"primary"` | `"auto"` \| `"black"` \| `"inverse"` \| `"primary"` \| `"secondary"` \| `"white"` |
| **itemsSize** | <div>Sets the font size of the menu items.</div> | `'sm'` | `"2xl"` \| `"3xl"` \| `"4xl"` \| `"5xl"` \| `"6xl"` \| `"7xl"` \| `"8xl"` \| `"9xl"` \| `"heading"` \| `"lg"` \| `"md"` \| `"sm"` \| `"text"` \| `"xl"` \| `"xs"` |
