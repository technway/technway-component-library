...
| -------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ----------- |
| `appearance`               | `appearance`                 | Determines the appearance of the navigation bar. Supports styles like 'outlined', 'solid', 'transparent', etc.                                                                                                                                                                                                                                                                                                                                                                                                | `"mixed" \| "none" \| "outlined" \| "outlined-bottom" \| "solid" \| "transparent"`                    | `'solid'`   |
| `appearanceColor`          | `appearance-color`           | Specifies the appearance color of the navigation bar. Available options include 'primary', 'secondary', 'black', 'white', etc.                                                                                                                                                                                                                                                                                                                                                                                | `"auto" \| "black" \| "inverse" \| "light" \| "primary" \| "secondary" \| "white"`                    | `'auto'`    |
...
| `enableMenuSlot`           | `enable-menu-slot`           | If true, the menu slot is enabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `boolean`                                                                                             | `true`      |
...
| `paddingHorizontal`        | `padding-horizontal`         | Sets the horizontal padding size of the navigation bar.                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `"lg" \| "md" \| "none" \| "sm"`                                                                      | `'md'`      |
| `paddingVertical`          | `padding-vertical`           | Sets the vertical padding size of the navigation bar.                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `"lg" \| "md" \| "none" \| "sm"`                                                                      | `'md'`      |
| `scopeStylesToContainer`   | `scope-styles-to-container`  | When true, the component will apply its styles (like the appearance colors and effects) to its internal container element. If false, the styles will be applied directly to the component host element.                                                                                                                                                                                                                                                                                                       | `boolean`                                                                                             | `false`     |
