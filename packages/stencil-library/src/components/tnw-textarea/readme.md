...
| -------------------------- | ------------------ | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ------------ |
| `alert`                    | `alert`            | Error alert displayed when the textarea is invalid.                           | `string`                                                                                              | `''`         |
| `alertType`                | `alert-type`       | Indicates if the textarea is in an invalid state.                             | `"danger" \| "info" \| "success" \| "warning"`                                                        | `undefined`  |
...
| `isInvalid`                | `is-invalid`       | Indicates if the textarea has invalid data.                                   | `boolean`                                                                                             | `false`      |
...
| `textareaId` _(required)_  | `textarea-id`      | The unique ID for the textarea element.                                       | `string`                                                                                              | `undefined`  |
| `value`                    | `value`            | The initial value of the textarea.                                            | `string`                                                                                              | `''`         |
| `variant`                  | `variant`          | Defines the color variant of the textarea.                                    | `"outlined" \| "underlined"`                                                                          | `'outlined'` |
