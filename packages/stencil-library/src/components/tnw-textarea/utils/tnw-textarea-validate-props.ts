...
export function validateProps(propsValues: any[]): void {
  const props = [{"name":"alert","type":["string"],"isRequired":false},{"name":"alertType","type":["danger","info","success","warning"],"isRequired":false},{"name":"autoComplete","type":["string"],"isRequired":false},{"name":"borderRadius","type":["2xl","3xl","circle","default","full","lg","md","none","sm","xl","xs"],"isRequired":false},{"name":"cols","type":["number"],"isRequired":false},{"name":"disabled","type":["boolean"],"isRequired":false},{"name":"helpText","type":["string"],"isRequired":false},{"name":"isInvalid","type":["boolean"],"isRequired":false},{"name":"isLabelSrOnly","type":["boolean"],"isRequired":false},{"name":"isRequired","type":["boolean"],"isRequired":false},{"name":"label","type":["string"],"isRequired":true},{"name":"maxlength","type":["number"],"isRequired":false},{"name":"minlength","type":["number"],"isRequired":false},{"name":"name","type":["string"],"isRequired":false},{"name":"placeholder","type":["string"],"isRequired":true},{"name":"resize","type":["both","horizontal","none","vertical"],"isRequired":false},{"name":"rows","type":["number"],"isRequired":false},{"name":"textareaId","type":["string"],"isRequired":true},{"name":"value","type":["string"],"isRequired":false},{"name":"variant","type":["outlined","underlined"],"isRequired":false}];
