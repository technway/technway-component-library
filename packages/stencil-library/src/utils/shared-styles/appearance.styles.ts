...
.tnw-extended-v-transparent-primary {
  color: var(--tnw-primary-color);
  fill: var(--tnw-primary-color);
}

.tnw-extended-v-transparent-secondary {
  color: var(--tnw-secondary-color);
  fill: var(--tnw-secondary-color);
}

.tnw-extended-v-transparent-auto {
  color: var(--tnw-text-color);
  fill: var(--tnw-text-color);
}

.tnw-extended-v-transparent-inverse {
  color: var(--tnw-text-color-inverse);
  fill: var(--tnw-text-color-inverse);
}

.tnw-extended-v-transparent-light {
  color: var(--tnw-text-color-light);
  fill: var(--tnw-text-color-light);
}

.tnw-extended-v-transparent-white {
  color: var(--tnw-white);
  fill: var(--tnw-white);
}

.tnw-extended-v-transparent-black {
  color: var(--tnw-black);
  fill: var(--tnw-black);
}

.tnw-extended-v-transparent-success {
  color: var(--tnw-success-color);
  fill: var(--tnw-success-color);
}

.tnw-extended-v-transparent-warning {
  color: var(--tnw-warning-color);
  fill: var(--tnw-warning-color);
}

.tnw-extended-v-transparent-danger {
  color: var(--tnw-danger-color);
  fill: var(--tnw-danger-color);
}

.tnw-extended-v-transparent-info {
  color: var(--tnw-info-color);
  fill: var(--tnw-info-color);
}

.tnw-extended-v-solid-primary,
.tnw-extended-v-solid-secondary,
.tnw-extended-v-solid-black {
  color: var(--tnw-white);
  fill: var(--tnw-white);
}

.tnw-extended-v-solid-white,
.tnw-extended-v-solid-success,
.tnw-extended-v-solid-warning,
.tnw-extended-v-solid-danger,
.tnw-extended-v-solid-info {
  color: var(--tnw-black);
  fill: var(--tnw-black);
}

.tnw-extended-v-solid-auto,
.tnw-extended-v-solid-light {
  color: var(--tnw-text-color);
  fill: var(--tnw-text-color);
}
...
.tnw-extended-v-solid-success {
  background-color: var(--tnw-success-color);
}

.tnw-extended-v-solid-warning {
  background-color: var(--tnw-warning-color);
}

.tnw-extended-v-solid-danger {
  background-color: var(--tnw-danger-color);
}

.tnw-extended-v-solid-info {
  background-color: var(--tnw-info-color);
}

.tnw-extended-v-mixed-primary,
.tnw-extended-v-mixed-secondary,
.tnw-extended-v-mixed-auto,
.tnw-extended-v-mixed-black,
.tnw-extended-v-mixed-danger,
.tnw-extended-v-mixed-info,
.tnw-extended-v-mixed-light,
.tnw-extended-v-mixed-success,
.tnw-extended-v-mixed-warning,
.tnw-extended-v-mixed-white {
  border-style: solid;
  border-width: var(--tnw-border-sm);
}
...
.tnw-extended-v-mixed-success {
  background-color: var(--tnw-success-color-200);
  border-color: var(--tnw-success-color-100);
}

.tnw-extended-v-mixed-warning {
  background-color: var(--tnw-warning-color-200);
  border-color: var(--tnw-warning-color-100);
}

.tnw-extended-v-mixed-danger {
  background-color: var(--tnw-danger-color-200);
  border-color: var(--tnw-danger-color-100);
}

.tnw-extended-v-mixed-info {
  background-color: var(--tnw-info-color-200);
  border-color: var(--tnw-info-color-100);
}

.tnw-extended-v-outlined-primary,
.tnw-extended-v-outlined-secondary,
.tnw-extended-v-outlined-auto,
.tnw-extended-v-outlined-black,
.tnw-extended-v-outlined-danger,
.tnw-extended-v-outlined-info,
.tnw-extended-v-outlined-inverse,
.tnw-extended-v-outlined-light,
.tnw-extended-v-outlined-success,
.tnw-extended-v-outlined-warning,
...
.tnw-extended-v-outlined-success {
  border-color: var(--tnw-success-color);
}

.tnw-extended-v-outlined-warning {
  border-color: var(--tnw-warning-color);
}

.tnw-extended-v-outlined-danger {
  border-color: var(--tnw-danger-color);
}

.tnw-extended-v-outlined-info {
  border-color: var(--tnw-info-color);
}
`;
